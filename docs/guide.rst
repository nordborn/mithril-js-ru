...
В случае с нашим todo-приложением, вид-модель нуждается в следующих вещах: он должен отслеживать список выполняющихся задач (todo) и поле добавления новых задач, и он должен отбрабаывать логику добавления 
